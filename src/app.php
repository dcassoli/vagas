...
$app->get('/busca/{filtro}/{valor}/{ordem}', function( $filtro, $valor, $ordem ) use($app){

		$data = $app["api"]->getDataJson( $app['json.data'] );	

		$ret = $app["api"]->search($data, $filtro, $valor, $ordem);
		
		$response = new Response();
		
		$response->setContent(json_encode( array( 'data' => $ret ) ));		
...
$app->error(function(\Exception $e, $code) use($app){
	...
	$message = "<strong>Erro encontrado: </strong>" . $e->getMessage() . "<br><br>";
	$message .= "<strong>Detalhes:</strong><br><pre>".$code."</pre>";
